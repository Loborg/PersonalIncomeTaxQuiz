...
public class QuizNine extends AppCompatActivity {
        ...
        nextIconImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isSubmiteButtonClicked) {
                    ...
                    Toast submiteButtonNotClicked = Toast.makeText(QuizNine.this, "You haven submitted any answers yet", Toast.LENGTH_SHORT);
    ...
    public void quizNineSubmiteButtonClick(View v){
        ...
        if (quizNineCorrectAnswer().equals("a")){
            Toast answer_a = Toast.makeText(QuizNine.this, "Your answer is incorrect", Toast.LENGTH_SHORT);
            answer_a.show();
            ...
            Toast answer_a = Toast.makeText(QuizNine.this, "Your answer is correct", Toast.LENGTH_SHORT);
            answer_a.show();
            quiz09Answer_C.setBackgroundColor(Color.GREEN);
            setAllRadioButtonNonClickable();
            Evaluation.quizAnswers[8] = quizNineCorrectAnswer();
        } else if (quizNineCorrectAnswer().equals("")){
            Toast answer_a = Toast.makeText(QuizNine.this, "You haven’t choose any of the answers", Toast.LENGTH_SHORT);
            answer_a.show();
            setAllRadioButtonNonClickable();
            Evaluation.quizAnswers[8] = quizNineCorrectAnswer();
        }
